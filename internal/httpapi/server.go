...
func (a *App) routes(h *handler.Handler) {
	...
	protected.POST("/subjects/:id/update", h.RequireCSRF(), h.UpdateSubject)
	protected.POST("/subjects/:id/chapters", h.RequireCSRF(), h.CreateChapter)
	protected.POST("/subjects/:id/tags", h.RequireCSRF(), h.ReplaceTags)
	protected.GET("/chapters/:id/annotations", h.ListAnnotations)
	protected.POST("/chapters/:id/update", h.RequireCSRF(), h.UpdateChapter)
	...
	protected.POST("/chapters/:id/whiteboard", h.RequireCSRF(), h.SaveWhiteboard)
